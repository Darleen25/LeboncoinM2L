    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-muted">Notre boutique de vêtements et tout autres articles diponibles pour vous faire plaisir.</p>
        </div>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong>DARLEEN & LICKH'Shop</strong>
      </a>
